// Package cfg defines the configuration struct and related methods for validation and flag registration.
package cfg
...
func (c *Config) RegisterFlags(fs *flag.FlagSet) {
	...
	fs.IntVar(&c.HTTPPort, "http-port", 8080, "HTTP listen TCP port (1..65535)")
}
...
func (c *Config) Validate() error {
	...
	// HTTP port must be valid TCP port number
